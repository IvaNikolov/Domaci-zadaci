...
public class Zadatak1 {
	...
	public static void main(String[] args) {
		...
		Igrac s = new Igrac("Milan Jovanovic", "0101985735074", 1999, 15, "playmaker", false);
		Igrac p = new Igrac("Vladimir Minic", "0101985735075", 2000, 17, "bek suter", false);

		Trener first = new Trener("Simon Simonovic", "0189654723", 1975, 15, "kondicioni");
